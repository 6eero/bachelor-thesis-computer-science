...
\def\thud@defheads#1{%
	...
	\def\@oddhead{\thud@headruledbox{#1}\leftmark\thepage}%
}
...
\newenvironment{dedication}{\begin{titlelike}{flushleft}}{\end{titlelike}}
...
\renewcommand{\tableofcontents}{\begingroup\pagestyle{empty}\oldtableofcontents\cleardoublepage\addtocounter{page}{-1}\endgroup}
