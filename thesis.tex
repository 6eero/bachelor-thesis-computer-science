...
\noindent A differenza del tradizionale rendering effettuato tramite JavaScript lato client, Next.js genera in anticipo (\textbf{pre-rendering}) il codice HTML per ciascuna pagina. Questa strategia consente di migliorare le performance e l'esperienza utente \cite{jartarghar2022react}. In particolare, Next.js implementa due forme di pre-rendering per affrontare le problematiche tipiche del rendering in React:
