...
La creazione di un nuovo progetto si effettua tramite la funzione \texttt{createProject}, la quale prende in input un oggetto \texttt{Project} e lo invia al database per la sua creazione:
