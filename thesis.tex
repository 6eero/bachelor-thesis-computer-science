...
\noindent Di seguito vengono presentati alcuni esempi significativi di casi di test implementati. Per ciascun caso, vengono descritti l'obiettivo specifico del test, i passi dettagliati necessari per la sua esecuzione e i risultati attesi, al fine di garantire una comprensione chiara e completa delle operazioni e delle verifiche effettuate.
...
\begin{itemize}
    ...
    \item \texttt{REQ08}: Un utente privo di account creato da un admin non può effetuare l'accesso.
