...
La matrice di copertura dei requisiti e dei casi di test consente di mappare in modo strutturato i requisiti funzionali del sistema ai casi di test progettati per verificarne la corretta implementazione. Nel contesto di questa tesi, la matrice fornisce una panoramica completa del grado di copertura del testing, identificando per ogni requisito specifico quali casi di test sono stati sviluppati per verificarlo.

\noindent Nel capitolo \ref{chapter_4}, sono stati definiti i requisiti che il sistema CRM deve soddisfare, mentre nel presente vengono descritti i casi di test associati \ref{test_cases}. Ogni caso di test è stato progettato per verificare uno o più dei requisiti precedentemente definiti.

\noindent La matrice, quindi, funge da strumento di riferimento per assicurare che ogni requisito sia correttamente implementato e funzionante. Nella matrice, per ogni incrocio tra requisito e caso di test, è presente una "X" che indica la copertura del requisito da parte del caso di test corrispondente.

\begin{table}[H]
    \centering
    \begin{tabular}{|c|l|c|c|c|c|}
    \hline
    \textbf{ID} & \multicolumn{1}{c|}{\textbf{Descrizione requisito}}                                                                                                 & \textbf{\begin{tabular}[c]{@{}c@{}}Creazione\\ Progetto\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Cancellazione\\ da Elenco\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Modifica\\ Progetto\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Accesso\\ Riservato\end{tabular}} \\ \hline
    \textbf{1}  & \begin{tabular}[c]{@{}l@{}}       Gli utenti possono creare \\ nuovi progetti.\end{tabular}                                                      & x                                                                     &                                                                            &                                                                      &                                                                      \\ \hline
    \textbf{2}  & \begin{tabular}[c]{@{}l@{}}       Gli utenti possono canellare \\ progetti dalla pagina di elenco.\end{tabular}                                  &                                                                       & x                                                                          &                                                                      &                                                                      \\ \hline
    \textbf{3}  & \begin{tabular}[c]{@{}l@{}}       Gli utenti possono canellare \\ progetti dalla pagina di dettaglio.\end{tabular}                              &                                                                       & x                                                                          &                                                                      &                                                                      \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \hline
    \textbf{ID} & \multicolumn{1}{c|}{\textbf{Descrizione requisito}}                                                                                                 & \textbf{\begin{tabular}[c]{@{}c@{}}Creazione\\ Progetto\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Cancellazione\\ da Elenco\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Modifica\\ Progetto\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Accesso\\ Riservato\end{tabular}} \\ \hline
    \textbf{4}  & \begin{tabular}[c]{@{}l@{}}       L'utente con ruolo PROJECT  \\ MANAGER può modificare i \\ dettagli di un progetto.\end{tabular}             &                                                                       &                                                                            & x                                                                    &                                                                      \\ \hline
    \textbf{5}  & \begin{tabular}[c]{@{}l@{}}       Gli utenti non autorizzati \\ non possono accedere  alla sezione \\ utenti.\end{tabular}                        &                                                                       &                                                                            &                                                                      & x                                                                    \\ \hline
    \textbf{6}  & \begin{tabular}[c]{@{}l@{}}       Le modifiche sono persistenti \\ dopo refresh, logout o login.\end{tabular}                                  & x                                                                     & x                                                                          & x                                                                    &                                                                      \\ \hline
    \textbf{7}  & \begin{tabular}[c]{@{}l@{}}       Le finestre modalidevono essere \\  visualizzate durante la conferma \\ delle azioni critiche.\end{tabular} &                                                                       & x                                                                          &                                                                      &                                                                      \\ \hline
    \textbf{8}  & \begin{tabular}[c]{@{}l@{}}       Gli utenti non autorizzati \\ che accedono a funzionalità \\ riservate visualizzano un errore.\end{tabular} &                                                                       &                                                                            &                                                                      & x                                                                    \\ \hline
    \end{tabular}
\end{table}
