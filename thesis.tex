...
\lstdefinelanguage{JavaScript}{
    ...
    keywords={break, case, catch, continue, debugger, default, delete, do, else, finally, for, function, if, in, instanceof, new, return, switch, throw, try, typeof, var, void, while, with, yield, const, let, async, await, import, export, from, as, interface},
    keywordstyle=\color{blue}\bfseries,
    ndkeywords={class, boolean, throw, implements, this, string, any, number, model, Project},
...
\lstdefinelanguage{React}{
    language=JavaScript,
    alsoletter={<>=-},
    morekeywords={JSX, render, Component, useState, useEffect, useContext, useReducer, useRef, useCallback, useMemo, createContext, PropTypes, Fragment, className, =>},
